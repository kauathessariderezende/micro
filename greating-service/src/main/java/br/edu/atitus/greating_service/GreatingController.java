...
public class GreatingController {
	...
	private final GreatingConfig greatingConfing; 
	
	public GreatingController(GreatingConfig greatingConfing) {
		super();
		this.greatingConfing = greatingConfing;
	}
	...
	public ResponseEntity<String> getGreating(
		...
		if (name == null)
			name = namePath != null ? namePath : greatingConfing.getDefaultName();
		
		String returnText = String.format("%s %s!", greatingConfing.getGreating(), name);
